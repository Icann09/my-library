  ...
  return (
    <section className="w-full rounded-2xl bg-white p-4 text-sm mb-10 sm:mb-0">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <h2 className="text-sm md:text-xl font-semibold">All Books</h2>
      ...
      <div className="mt-1 md:mt-7 w-full overflow-hidden">
        <div className="overflow-x-auto p-4">
          <table className="min-w-full table-auto border-collapse" id="books-table">
            <thead>
              <tr className="text-left bg-gray-50">
                <th className="p-1 md:p-3">Book Title</th>
                <th className="p-1 md:p-3">Author</th>
                <th className="p-1 md:p-3">Genre</th>
                <th className="p-1 md:p-3">Date Created</th>
                <th className="p-1 md:p-3">Action</th>
              </tr>
            </thead>
