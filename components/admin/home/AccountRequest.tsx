  ...
  return (
    <div className="p-[10px] rounded-xl border border-[#E4E4F0] bg-white max-w-[540px] h-[380px] flex flex-col relative">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-sm sm:text-xl font-semibold text-gray-900">Account Requests</h2>
      ...
      <div className="relative flex-1 overflow-hidden">
        <div className="flex flex-col gap-2 overflow-x-auto sm:overflow-visible pr-2 h-full">
